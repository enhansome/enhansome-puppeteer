...
* [![china](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **中文/Chinese**](https://github.com/transitive-bullshit/awesome-puppeteer/blob/master/readme.zh.md) ⭐ 2,566 | 🐛 25 | 📅 2024-07-19
...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,458 | 🐛 261 | 🌐 TypeScript | 📅 2026-08-13 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,458 | 🐛 261 | 🌐 TypeScript | 📅 2026-08-13 - Official API docs.
...
* [puppeteer-extra](https://github.com/berstend/puppeteer-extra) ⭐ 7,396 | 🐛 274 | 🌐 JavaScript | 📅 2024-07-18 - Wrapper to use stealth mode, custom user prefs, etc.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 990 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-12 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 383 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,458 | 🐛 261 | 🌐 TypeScript | 📅 2026-08-13 to **image**, **GIF** or **MP4**.
...
* [puppeteer-lottie-cli](https://github.com/transitive-bullshit/puppeteer-lottie-cli) ⭐ 150 | 🐛 26 | 🌐 JavaScript | 📅 2023-08-04 - CLI for this [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 383 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,370 | 🐛 139 | 🌐 TypeScript | 📅 2026-08-13 - Scalable web crawling and scraping library. 🕷️
* [headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) ⭐ 5,642 | 🐛 33 | 🌐 JavaScript | 📅 2023-04-29 - Distributed crawler powered by Headless Chrome.
* [BrowserGap](https://github.com/dosyago/BrowserGap) ⭐ 3,892 | 🐛 0 | 🌐 Shell | 📅 2026-08-12 - Remote browser webview powered by Headless Chrome.
...
* [storybook-chrome-screenshot](https://github.com/tsuyoshiwada/storybook-chrome-screenshot) ⭐ 755 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-11 - Storybook addon to save screenshots of your stories via puppeteer.
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,585 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-13 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,458 | 🐛 261 | 🌐 TypeScript | 📅 2026-08-13 - Quality examples as part of the official puppeteer repo.
...
* [puppeteer-sharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,913 | 🐛 12 | 🌐 C# | 📅 2026-08-11 - Port of Puppeteer to .NET.
