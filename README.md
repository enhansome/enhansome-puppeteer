...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,578 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-14 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,578 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-14 - Official API docs.
...
* [chrome-aws-lambda](https://github.com/alixaxel/chrome-aws-lambda) ⭐ 3,286 | 🐛 77 | 🌐 TypeScript | 📅 2024-09-03 - Chromium binary compatible with AWS Lambda (kept up to date with puppeteer).
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 1,006 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-13 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,578 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-14 to **image**, **GIF** or **MP4**.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,798 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-14 - Scalable web crawling and scraping library. 🕷️
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,695 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-14 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
* [url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) ⭐ 7,103 | 🐛 61 | 🌐 HTML | 📅 2024-01-18 - Web page PDF rendering done right. Self-hosted service for rendering.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,578 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-14 - Quality examples as part of the official puppeteer repo.
...
* [pyppeteer](https://github.com/pyppeteer/pyppeteer) ⭐ 3,941 | 🐛 212 | 🌐 Python | 📅 2024-06-29 - Unofficial Python port of Puppeteer.
* [puppeteer-sharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,919 | 🐛 14 | 🌐 C# | 📅 2026-09-14 - Port of Puppeteer to .NET.
