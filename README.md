...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,622 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-25 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,622 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-25 - Official API docs.
...
* [pwa-asset-generator](https://github.com/onderceylan/pwa-asset-generator) ⭐ 3,036 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-24 - CLI to generate multi-platform PWA icons, splash screens and meta code based on web standards.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 1,008 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-24 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 386 | 🐛 23 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,622 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-25 to **image**, **GIF** or **MP4**.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,894 | 🐛 134 | 🌐 TypeScript | 📅 2026-09-25 - Scalable web crawling and scraping library. 🕷️
...
* [BrowserGap](https://github.com/dosyago/BrowserGap) ⭐ 3,915 | 🐛 0 | 🌐 Shell | 📅 2026-09-23 - Remote browser webview powered by Headless Chrome.
* [decktape](https://github.com/astefanutti/decktape) ⭐ 2,429 | 🐛 50 | 🌐 JavaScript | 📅 2026-07-13 - PDF exporter for HTML presentation frameworks.
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,735 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-25 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,622 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-25 - Quality examples as part of the official puppeteer repo.
...
* [Official use case-driven examples](https://github.com/GoogleChromeLabs/puppeteer-examples) ⭐ 2,416 | 🐛 39 | 🌐 JavaScript | 📅 2026-06-21 - More complex, high quality, use case-driven examples.
...
* [puppeteer-sharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,921 | 🐛 12 | 🌐 C# | 📅 2026-09-24 - Port of Puppeteer to .NET.
