...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,558 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-09 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,558 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-09 - Official API docs.
...
* [puppeteer-extra](https://github.com/berstend/puppeteer-extra) ⭐ 7,397 | 🐛 275 | 🌐 JavaScript | 📅 2024-07-18 - Wrapper to use stealth mode, custom user prefs, etc.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 999 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-08 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,558 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-09 to **image**, **GIF** or **MP4**.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,706 | 🐛 140 | 🌐 TypeScript | 📅 2026-09-09 - Scalable web crawling and scraping library. 🕷️
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,677 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-09 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,558 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-09 - Quality examples as part of the official puppeteer repo.
