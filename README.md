...
* [![china](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **中文/Chinese**](https://github.com/transitive-bullshit/awesome-puppeteer/blob/master/readme.zh.md) ⭐ 2,573 | 🐛 25 | 📅 2024-07-19
...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,531 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-31 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,531 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-31 - Official API docs.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 996 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-31 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,531 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-31 to **image**, **GIF** or **MP4**.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,583 | 🐛 153 | 🌐 TypeScript | 📅 2026-08-31 - Scalable web crawling and scraping library. 🕷️
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,647 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-31 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,531 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-31 - Quality examples as part of the official puppeteer repo.
...
* [pyppeteer](https://github.com/pyppeteer/pyppeteer) ⭐ 3,940 | 🐛 213 | 🌐 Python | 📅 2024-06-29 - Unofficial Python port of Puppeteer.
* [puppeteer-sharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,916 | 🐛 11 | 🌐 C# | 📅 2026-08-30 - Port of Puppeteer to .NET.
