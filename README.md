...
* [![china](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **中文/Chinese**](https://github.com/transitive-bullshit/awesome-puppeteer/blob/master/readme.zh.md) ⭐ 2,575 | 🐛 25 | 📅 2024-07-19
...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,558 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-06 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,558 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-06 - Official API docs.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 1,000 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-05 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,558 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-06 to **image**, **GIF** or **MP4**.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,667 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-04 - Scalable web crawling and scraping library. 🕷️
...
* [BrowserGap](https://github.com/dosyago/BrowserGap) ⭐ 3,904 | 🐛 0 | 🌐 Shell | 📅 2026-08-26 - Remote browser webview powered by Headless Chrome.
...
* [storybook-chrome-screenshot](https://github.com/tsuyoshiwada/storybook-chrome-screenshot) ⭐ 755 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-03 - Storybook addon to save screenshots of your stories via puppeteer.
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,666 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-05 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,558 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-06 - Quality examples as part of the official puppeteer repo.
