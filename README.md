...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,581 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-13 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,581 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-13 - Official API docs.
...
* [puppeteer-extra](https://github.com/berstend/puppeteer-extra) ⭐ 7,399 | 🐛 275 | 🌐 JavaScript | 📅 2024-07-18 - Wrapper to use stealth mode, custom user prefs, etc.
...
* [pwa-asset-generator](https://github.com/onderceylan/pwa-asset-generator) ⭐ 3,032 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-10 - CLI to generate multi-platform PWA icons, splash screens and meta code based on web standards.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 1,004 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-12 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,581 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-13 to **image**, **GIF** or **MP4**.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,770 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-11 - Scalable web crawling and scraping library. 🕷️
...
* [BrowserGap](https://github.com/dosyago/BrowserGap) ⭐ 3,912 | 🐛 0 | 🌐 Shell | 📅 2026-09-12 - Remote browser webview powered by Headless Chrome.
...
* [Wbot](https://github.com/vasani-arpit/WBOT) ⭐ 1,012 | 🐛 16 | 🌐 JavaScript | 📅 2025-09-23 - Configurable Whatsapp auto reply bot.
...
* [storybook-chrome-screenshot](https://github.com/tsuyoshiwada/storybook-chrome-screenshot) ⭐ 755 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-10 - Storybook addon to save screenshots of your stories via puppeteer.
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,689 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-11 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
* [url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) ⭐ 7,102 | 🐛 61 | 🌐 HTML | 📅 2024-01-18 - Web page PDF rendering done right. Self-hosted service for rendering.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,581 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-13 - Quality examples as part of the official puppeteer repo.
...
* [puppeteer-sharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,919 | 🐛 11 | 🌐 C# | 📅 2026-09-12 - Port of Puppeteer to .NET.
