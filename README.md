...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,580 | 🐛 257 | 🌐 TypeScript | 📅 2026-09-09 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,580 | 🐛 257 | 🌐 TypeScript | 📅 2026-09-09 - Official API docs.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 1,001 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-11 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,580 | 🐛 257 | 🌐 TypeScript | 📅 2026-09-09 to **image**, **GIF** or **MP4**.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,753 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-11 - Scalable web crawling and scraping library. 🕷️
...
* [BrowserGap](https://github.com/dosyago/BrowserGap) ⭐ 3,912 | 🐛 0 | 🌐 Shell | 📅 2026-09-06 - Remote browser webview powered by Headless Chrome.
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,683 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-11 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
* [url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) ⭐ 7,101 | 🐛 61 | 🌐 HTML | 📅 2024-01-18 - Web page PDF rendering done right. Self-hosted service for rendering.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,580 | 🐛 257 | 🌐 TypeScript | 📅 2026-09-09 - Quality examples as part of the official puppeteer repo.
...
* [puppeteer-sharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,918 | 🐛 11 | 🌐 C# | 📅 2026-09-12 - Port of Puppeteer to .NET.
