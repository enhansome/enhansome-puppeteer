...
* [![china](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **中文/Chinese**](https://github.com/transitive-bullshit/awesome-puppeteer/blob/master/readme.zh.md) ⭐ 2,577 | 🐛 25 | 📅 2024-07-19
...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,566 | 🐛 260 | 🌐 TypeScript | 📅 2026-09-08 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,566 | 🐛 260 | 🌐 TypeScript | 📅 2026-09-08 - Official API docs.
...
* [puppeteer-extra](https://github.com/berstend/puppeteer-extra) ⭐ 7,398 | 🐛 275 | 🌐 JavaScript | 📅 2024-07-18 - Wrapper to use stealth mode, custom user prefs, etc.
...
* [pwa-asset-generator](https://github.com/onderceylan/pwa-asset-generator) ⭐ 3,032 | 🐛 51 | 🌐 TypeScript | 📅 2026-06-01 - CLI to generate multi-platform PWA icons, splash screens and meta code based on web standards.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 1,000 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-08 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [timecut](https://github.com/tungs/timecut) ⭐ 652 | 🐛 33 | 🌐 JavaScript | 📅 2023-07-18 - Record smooth movies of web pages with JavaScript animations.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,566 | 🐛 260 | 🌐 TypeScript | 📅 2026-09-08 to **image**, **GIF** or **MP4**.
...
* [puppeteer-lottie-cli](https://github.com/transitive-bullshit/puppeteer-lottie-cli) ⭐ 150 | 🐛 26 | 🌐 JavaScript | 📅 2023-08-04 - CLI for this [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,697 | 🐛 144 | 🌐 TypeScript | 📅 2026-09-08 - Scalable web crawling and scraping library. 🕷️
...
* [BrowserGap](https://github.com/dosyago/BrowserGap) ⭐ 3,907 | 🐛 0 | 🌐 Shell | 📅 2026-09-06 - Remote browser webview powered by Headless Chrome.
* [decktape](https://github.com/astefanutti/decktape) ⭐ 2,425 | 🐛 50 | 🌐 JavaScript | 📅 2026-07-13 - PDF exporter for HTML presentation frameworks.
...
* [puppeteer-renderer](https://github.com/zenato/puppeteer-renderer) ⭐ 334 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-19 - Generic web page renderer.
...
* [jest-puppeteer](https://github.com/smooth-code/jest-puppeteer) ⭐ 3,545 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-26 - Run your tests using Jest & Puppeteer.
* [expect-puppeteer](https://github.com/smooth-code/jest-puppeteer/tree/master/packages/expect-puppeteer) ⭐ 3,545 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-26 - Assertion library for Puppeteer.
* [storybook-chrome-screenshot](https://github.com/tsuyoshiwada/storybook-chrome-screenshot) ⭐ 755 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-08 - Storybook addon to save screenshots of your stories via puppeteer.
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,674 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-08 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
* [url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) ⭐ 7,101 | 🐛 60 | 🌐 HTML | 📅 2024-01-18 - Web page PDF rendering done right. Self-hosted service for rendering.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,566 | 🐛 260 | 🌐 TypeScript | 📅 2026-09-08 - Quality examples as part of the official puppeteer repo.
...
* [pyppeteer](https://github.com/pyppeteer/pyppeteer) ⭐ 3,942 | 🐛 212 | 🌐 Python | 📅 2024-06-29 - Unofficial Python port of Puppeteer.
* [puppeteer-sharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,917 | 🐛 11 | 🌐 C# | 📅 2026-09-05 - Port of Puppeteer to .NET.
