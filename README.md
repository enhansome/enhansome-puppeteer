...
* [![china](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **中文/Chinese**](https://github.com/transitive-bullshit/awesome-puppeteer/blob/master/readme.zh.md) ⭐ 2,576 | 🐛 25 | 📅 2024-07-19
...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,565 | 🐛 259 | 🌐 TypeScript | 📅 2026-09-07 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,565 | 🐛 259 | 🌐 TypeScript | 📅 2026-09-07 - Official API docs.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 1,000 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-07 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,565 | 🐛 259 | 🌐 TypeScript | 📅 2026-09-07 to **image**, **GIF** or **MP4**.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,683 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-07 - Scalable web crawling and scraping library. 🕷️
...
* [BrowserGap](https://github.com/dosyago/BrowserGap) ⭐ 3,905 | 🐛 0 | 🌐 Shell | 📅 2026-09-06 - Remote browser webview powered by Headless Chrome.
...
* [storybook-chrome-screenshot](https://github.com/tsuyoshiwada/storybook-chrome-screenshot) ⭐ 755 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-07 - Storybook addon to save screenshots of your stories via puppeteer.
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,673 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-07 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
* [url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) ⭐ 7,102 | 🐛 60 | 🌐 HTML | 📅 2024-01-18 - Web page PDF rendering done right. Self-hosted service for rendering.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,565 | 🐛 259 | 🌐 TypeScript | 📅 2026-09-07 - Quality examples as part of the official puppeteer repo.
