...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,461 | 🐛 266 | 🌐 TypeScript | 📅 2026-08-16 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,461 | 🐛 266 | 🌐 TypeScript | 📅 2026-08-16 - Official API docs.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 991 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-15 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 383 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,461 | 🐛 266 | 🌐 TypeScript | 📅 2026-08-16 to **image**, **GIF** or **MP4**.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,405 | 🐛 146 | 🌐 TypeScript | 📅 2026-08-15 - Scalable web crawling and scraping library. 🕷️
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,595 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-14 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,461 | 🐛 266 | 🌐 TypeScript | 📅 2026-08-16 - Quality examples as part of the official puppeteer repo.
