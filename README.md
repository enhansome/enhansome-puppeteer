...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,536 | 🐛 261 | 🌐 TypeScript | 📅 2026-09-02 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,536 | 🐛 261 | 🌐 TypeScript | 📅 2026-09-02 - Official API docs.
...
* [pwa-asset-generator](https://github.com/onderceylan/pwa-asset-generator) ⭐ 3,031 | 🐛 51 | 🌐 TypeScript | 📅 2026-06-01 - CLI to generate multi-platform PWA icons, splash screens and meta code based on web standards.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 998 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-02 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,536 | 🐛 261 | 🌐 TypeScript | 📅 2026-09-02 to **image**, **GIF** or **MP4**.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,612 | 🐛 146 | 🌐 TypeScript | 📅 2026-09-02 - Scalable web crawling and scraping library. 🕷️
...
* [decktape](https://github.com/astefanutti/decktape) ⭐ 2,424 | 🐛 50 | 🌐 JavaScript | 📅 2026-07-13 - PDF exporter for HTML presentation frameworks.
...
* [storybook-chrome-screenshot](https://github.com/tsuyoshiwada/storybook-chrome-screenshot) ⭐ 755 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-31 - Storybook addon to save screenshots of your stories via puppeteer.
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,656 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-02 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,536 | 🐛 261 | 🌐 TypeScript | 📅 2026-09-02 - Quality examples as part of the official puppeteer repo.
...
* [instagram-get-images](https://github.com/aofdev/instagram-get-images) ⭐ 79 | 🐛 7 | 🌐 JavaScript | 📅 2026-07-29 - Instagram image scraper.
...
* [puppeteer-sharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,917 | 🐛 11 | 🌐 C# | 📅 2026-08-30 - Port of Puppeteer to .NET.
