...
* [![china](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **中文/Chinese**](https://github.com/transitive-bullshit/awesome-puppeteer/blob/master/readme.zh.md) ⭐ 2,581 | 🐛 26 | 📅 2024-07-19
...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,620 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-24 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,620 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-24 - Official API docs.
...
* [puppeteer-extra](https://github.com/berstend/puppeteer-extra) ⭐ 7,402 | 🐛 275 | 🌐 JavaScript | 📅 2024-07-18 - Wrapper to use stealth mode, custom user prefs, etc.
...
* [pwa-asset-generator](https://github.com/onderceylan/pwa-asset-generator) ⭐ 3,036 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-24 - CLI to generate multi-platform PWA icons, splash screens and meta code based on web standards.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 1,008 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-23 - Efficient and flexible adblocker library to easily block ads and trackers.
* [capture-website-cli](https://github.com/sindresorhus/capture-website-cli) ⭐ 853 | 🐛 0 | 🌐 JavaScript | 📅 2025-11-01 - CLI to capture screenshots of websites.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 386 | 🐛 23 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,620 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-24 to **image**, **GIF** or **MP4**.
...
* [puppeteer-email](https://github.com/transitive-bullshit/puppeteer-email) ⭐ 166 | 🐛 10 | 🌐 JavaScript | 📅 2021-01-05 - Email automation driven by headless chrome.
* [puppeteer-email-cli](https://github.com/transitive-bullshit/puppeteer-email/tree/master/packages/puppeteer-email-cli) ⭐ 166 | 🐛 10 | 🌐 JavaScript | 📅 2021-01-05 - CLI for email automation driven by headless chrome.
* [puppeteer-lottie-cli](https://github.com/transitive-bullshit/puppeteer-lottie-cli) ⭐ 150 | 🐛 26 | 🌐 JavaScript | 📅 2023-08-04 - CLI for this [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 386 | 🐛 23 | 🌐 JavaScript | 📅 2023-07-25.
* [puppeteer-explore](https://github.com/laispace/puppeteer-explore) ⭐ 144 | 🐛 0 | 📅 2017-10-19 - Utility library for puppeteer.
* [puppeteer-instagram](https://github.com/transitive-bullshit/puppeteer-instagram) ⭐ 118 | 🐛 23 | 🌐 JavaScript | 📅 2022-12-07 - Instagram automation driven by headless chrome.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,883 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-24 - Scalable web crawling and scraping library. 🕷️
* [headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) ⭐ 5,637 | 🐛 33 | 🌐 JavaScript | 📅 2023-04-29 - Distributed crawler powered by Headless Chrome.
* [BrowserGap](https://github.com/dosyago/BrowserGap) ⭐ 3,914 | 🐛 0 | 🌐 Shell | 📅 2026-09-23 - Remote browser webview powered by Headless Chrome.
* [decktape](https://github.com/astefanutti/decktape) ⭐ 2,428 | 🐛 50 | 🌐 JavaScript | 📅 2026-07-13 - PDF exporter for HTML presentation frameworks.
...
* [puppeteer-renderer](https://github.com/zenato/puppeteer-renderer) ⭐ 334 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-15 - Generic web page renderer.
* [prerenderer](https://github.com/Tribex/prerenderer) ⭐ 230 | 🐛 7 | 🌐 TypeScript | 📅 2024-09-26 - Framework-agnostic prerendering for sites and SPAs.
...
* [storybook-chrome-screenshot](https://github.com/tsuyoshiwada/storybook-chrome-screenshot) ⭐ 755 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-23 - Storybook addon to save screenshots of your stories via puppeteer.
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,735 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-24 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,620 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-24 - Quality examples as part of the official puppeteer repo.
...
* [pyppeteer](https://github.com/pyppeteer/pyppeteer) ⭐ 3,943 | 🐛 212 | 🌐 Python | 📅 2024-06-29 - Unofficial Python port of Puppeteer.
* [puppeteer-sharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,921 | 🐛 14 | 🌐 C# | 📅 2026-09-24 - Port of Puppeteer to .NET.
