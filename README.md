...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,460 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-14 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,460 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-14 - Official API docs.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 991 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-14 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 383 | 🐛 22 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,460 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-14 to **image**, **GIF** or **MP4**.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,394 | 🐛 142 | 🌐 TypeScript | 📅 2026-08-15 - Scalable web crawling and scraping library. 🕷️
...
* [BrowserGap](https://github.com/dosyago/BrowserGap) ⭐ 3,895 | 🐛 0 | 🌐 Shell | 📅 2026-08-13 - Remote browser webview powered by Headless Chrome.
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,588 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-14 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,460 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-14 - Quality examples as part of the official puppeteer repo.
...
* [puppeteer-sharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,913 | 🐛 10 | 🌐 C# | 📅 2026-08-14 - Port of Puppeteer to .NET.
