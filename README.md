...
* [GitHub](https://github.com/GoogleChrome/puppeteer) ⭐ 95,615 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-23 - Official GitHub repository.
* [API](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md) ⭐ 95,615 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-23 - Official API docs.
...
* [puppeteer-extra](https://github.com/berstend/puppeteer-extra) ⭐ 7,400 | 🐛 275 | 🌐 JavaScript | 📅 2024-07-18 - Wrapper to use stealth mode, custom user prefs, etc.
...
* [pwa-asset-generator](https://github.com/onderceylan/pwa-asset-generator) ⭐ 3,036 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-21 - CLI to generate multi-platform PWA icons, splash screens and meta code based on web standards.
...
* [@cliqz/adblocker-puppeteer](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-puppeteer) ⭐ 1,008 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-22 - Efficient and flexible adblocker library to easily block ads and trackers.
...
* [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 23 | 🌐 JavaScript | 📅 2023-07-25 - Renders [Lottie](http://airbnb.io/lottie) animations via [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,615 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-23 to **image**, **GIF** or **MP4**.
...
* [puppeteer-lottie-cli](https://github.com/transitive-bullshit/puppeteer-lottie-cli) ⭐ 150 | 🐛 26 | 🌐 JavaScript | 📅 2023-08-04 - CLI for this [puppeteer-lottie](https://github.com/transitive-bullshit/puppeteer-lottie) ⭐ 385 | 🐛 23 | 🌐 JavaScript | 📅 2023-07-25.
...
* [Apify SDK](https://github.com/apifytech/apify-js) ⭐ 25,873 | 🐛 146 | 🌐 TypeScript | 📅 2026-09-23 - Scalable web crawling and scraping library. 🕷️
...
* [storybook-chrome-screenshot](https://github.com/tsuyoshiwada/storybook-chrome-screenshot) ⭐ 755 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-21 - Storybook addon to save screenshots of your stories via puppeteer.
...
* [browserless](https://github.com/joelgriffith/browserless) ⭐ 13,732 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-22 - Headless Chrome as a service letting you execute Puppeteer scripts remotely.
...
* [Official examples](https://github.com/puppeteer/puppeteer/tree/main/examples) ⭐ 95,615 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-23 - Quality examples as part of the official puppeteer repo.
...
* [puppeteer-sharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,921 | 🐛 18 | 🌐 C# | 📅 2026-09-23 - Port of Puppeteer to .NET.
